    ...
    <div className="mt-[125px] min-h-[90vh] relative overflow-hidden">
      ...
      <Container>
        <div className="flex gap-3 flex-wrap w-full">
          {teamMembers.filter(m=>m.category.includes("technical")).map((m, j) => {
            return (
      ...
      <Container>
        <div className="flex gap-3 flex-wrap w-full">
        {teamMembers.filter(m=>m.category.includes("cultural")).map((m, j) => {
            return (
              <div className="overflow-hidden" key={j}>
                {
                  <TeamMemebrsCard member={m}/>
      ...
      <Container>
        <div className="flex gap-3 flex-wrap w-full">
        {teamMembers.filter(m=>m.category.includes("sponsor")).map((m, j) => {
            return (
              <div className="overflow-hidden" key={j}>
                {
                  <TeamMemebrsCard member={m}/>
      ...
      <Container>
        <div className="flex gap-3 flex-wrap w-full">
        {teamMembers.filter(m=>m.category.includes("management")).map((m, j) => {
            return (
              <div className="overflow-hidden" key={j}>
                {
                  <TeamMemebrsCard member={m}/>
